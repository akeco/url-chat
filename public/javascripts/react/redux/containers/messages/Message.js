...
import {teal900, teal800, teal500, teal400, teal100, lime500} from 'material-ui/styles/colors';
            ...
            >
                ...
                >
                    <div style={style.contactBlock}>
                        {
                            onlineUser && <div className="rotatingOnlineBlock" style={style.online} />
                        }
                        <Account style={style.avatar} />
                        {
                           (!this.props.private && sender._id != this.props.profileuser._id && !!onlineUser) && (
                                <IconButton
                                    style={{
